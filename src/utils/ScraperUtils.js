...
export const validateOptions = (options = {}) => {
  ...
  return {
    ...defaults,
    ...options,
    modelsPerBrand: Math.min(options.modelsPerBrand || 10, 50),
    minYear: Math.max(options.minYear || 2022, 2020)
  };
};
 ...
 */
export const generateFilename = (prefix = 'gsm-data', extension = 'json') => {
